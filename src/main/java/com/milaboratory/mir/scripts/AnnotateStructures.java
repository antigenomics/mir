...
import com.milaboratory.mir.structure.output.ComplexAnnotationWriter;
import com.milaboratory.mir.structure.output.GeneralAnnotationWriter;
import com.milaboratory.mir.structure.output.MarkupAnnotationWriter;
import com.milaboratory.mir.structure.output.ResidueMarkupAnnotationWriter;
...
public class AnnotateStructures implements Callable<Void> {
    ...
    public Void call() throws Exception {
        ...
        try (var writer = new ComplexAnnotationWriter(Arrays.asList(
