/*
 * Taken from Guava and stripped from unused dependencies
 * https://github.com/google/guava/blob/master/guava/src/com/google/common/util/concurrent/AtomicDoubleArray.java
 */
...
package com.milaboratory.mir.thirdparty;
...
public class AtomicDoubleArray implements java.io.Serializable {
    ...
    private void readObject(java.io.ObjectInputStream s)
        ...
        for (int i = 0; i < length; i++) {
            arr[i] = doubleToRawLongBits(s.readDouble());
        }
        this.longs = new AtomicLongArray(arr);
    }
}
