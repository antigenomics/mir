...
public final class HitWithAlignmentImpl<Q, T, S extends Sequence<S>> implements HitWithAlignment<Q, T, S> {
    private final Q query;
    private final T target;
    private final Alignment<S> alignment;

    public HitWithAlignmentImpl(Q query, T target, Alignment<S> alignment) {
        this.query = query;
        this.target = target;
    ...
    @Override
    public int hashCode() {
        return Objects.hash(query, target, alignment);
    }
}
